                      ...
                      <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="font-size: 16px;">
                            <div class="layui-row layui-col-space10">
                                ...
                                <i class="layui-icon layui-icon-male" style="font-size: 20px; color:#689ED3;"></i>   
                                </div>
                                <div class="layui-col-xs6 layui-col-sm4 layui-col-md3">
                                <i class="layui-icon layui-icon-female" style="font-size: 20px; color: #FC62CE"></i>   
                                </div>
                            </div>
